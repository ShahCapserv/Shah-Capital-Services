...
export const Route = createFileRoute('/(pages)/project-details')({
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="project-details__left">
                <div className="project-details__img">
                  <img
                    src={projectDetailsImg1}
                    style={{ width: 'auto', height: 'auto' }}
                    alt="Project overview - electrical repair work"
                  />
                </div>
                ...
                <div className="project-details__text-and-img">
                  ...
                  <div className="project-details__text-img">
                    <img
                      src={projectDetailsTextImg}
                      style={{ width: 'auto', height: 'auto' }}
                      alt="Technician working on project challenge"
                    />
                  </div>
                </div>
                ...
                <div className="project-details__img-and-points">
                  <div className="project-details__points-img">
                    <img
                      src={projectDetailsPointsImg}
                      style={{ width: 'auto', height: 'auto' }}
                      alt="Project result highlights"
                    />
                  </div>
              ...
              <div className="project-details__sidebar">
                ...
                <div className="service-details__get-started">
                  ...
                  <div className="service-details__get-started-btn-box">
                    <Link
                      to="/contact"
                      className="service-details__get-started-btn thm-btn"
                    >
                      Get In Touch
                    </Link>
                  </div>
            ...
            <div className="col-xl-12">
              <div className="project-details__previous-next">
                <ul>
                  <li>
                    <div className="icon">
                      <a href="#" aria-label="Previous project icon">
                        <span className="icon-arrow-right"></span>
                      </a>
                    </div>
                  ...
                  <li>
                    ...
                    <div className="icon">
                      <a href="#" aria-label="Next project icon">
                        <span className="icon-arrow-right"></span>
                      </a>
                    </div>
                  </li>
