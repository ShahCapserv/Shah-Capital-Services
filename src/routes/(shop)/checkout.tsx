...
function RouteComponent() {
  ...
  const handleBillingDetails = (e: SubmitEvent<HTMLFormElement>) => {
    e.preventDefault()
  }

  return (
    <main>
      <Banner title="Checkout" subTitle="Checkout" />
                  ...
                  <div className="checkout__payment">
                    ...
                    >
                      ...
                      >
                        ...
                        one bank account to another without using cash, checks,
                        or third-party payment services.
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        send and receive money securely. It supports personal
                        and business transactions, including shopping,
                        invoicing, and international transfers.
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        A cheque payment is a written, dated, and signed
                        document that instructs a bank to pay a specific amount
                        of money from the {`issuer's`} account to the payee.
                      </div>
                    </div>
                  </div>
                </div>
