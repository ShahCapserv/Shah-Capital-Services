...
type ProgressBarComponent = typeof ProgressBarImport

type ProgressBarModuleShape =
  | ProgressBarComponent
  | { default: ProgressBarComponent }

const progressBarModule = ProgressBarImport as ProgressBarModuleShape
const ProgressBarResolved =
  'default' in progressBarModule ? progressBarModule.default : progressBarModule
    ...
    <li ref={ref}>
      <div className="why-choose-two__progress">
        <div className="d-flex justify-content-between align-items-center">
          <h4 className="why-choose-two__progress-title">
            {showTitle ? title : ''}
          </h4>
          <span>{progress}%</span>
        </div>
