  ...
  return (
    <ul className="main-menu__list mobileManulist">
      <li className="dropdown">
        <a
          href="#"
          className={`${isHome || findLocation(homeList) ? 'expanded' : ''}`}
        >
          Home
          <button
            className={`${isHome ? 'expanded' : ''}`}
            onClick={() => setIsHome((pre) => !pre)}
          >
            {' '}
      ...
      <li className="dropdown">
        <a
          href="#"
          className={`${isPages || findLocation(pagesList) ? 'expanded' : ''}`}
        >
          Pages
          <button
            onClick={() => setIsPages((pre) => !pre)}
            className={`${isPages ? 'expanded' : ''}`}
          >
            {' '}
            <i className="fa fa-angle-down"></i>
          </button>
        ...
        <ul
          className="shadow-box"
          style={{ display: `${isPages ? 'block' : 'none'}` }}
        >
      ...
      <li className="dropdown">
        <a
          href="#"
          className={`${isCars || findLocation(servicesList) ? 'expanded' : ''}`}
        >
          Services
          <button
            className={`${isCars ? 'expanded' : ''}`}
            onClick={() => setIsCars((pre) => !pre)}
          >
            {' '}
            <i className="fa fa-angle-down"></i>
          </button>
        ...
        <ul
          className="shadow-box"
          style={{ display: `${isCars ? 'block' : 'none'}` }}
        >
      ...
      <li className="dropdown">
        <a
          href="#"
          className={`${isShop || findLocation(shopList) ? 'expanded' : ''}`}
        >
          Shop
          <button
            className={`${isShop ? 'expanded' : ''}`}
            onClick={() => setIsShop((pre) => !pre)}
          >
            {' '}
            <i className="fa fa-angle-down"></i>
          </button>
        ...
        <ul
          className="shadow-box"
          style={{ display: `${isShop ? 'block' : 'none'}` }}
        >
      ...
      <li className="dropdown">
        <a
          href="#"
          className={`${isBlog || findLocation(blogList) ? 'expanded' : ''}`}
        >
          Blog
          <button
            className={`${isBlog ? 'expanded' : ''}`}
        ...
        <ul
          className="shadow-box"
          style={{ display: `${isBlog ? 'block' : 'none'}` }}
        >
