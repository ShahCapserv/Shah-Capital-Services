...
export const homeList: MenuItem[] = [
  ...
  {
    id: 4,
    menuItem: 'Home One Single Page',
    menuLink: '/single-page-home-one',
  },
  {
    id: 5,
    menuItem: 'Home Two Single Page',
    menuLink: '/single-page-home-two',
  },
  {
    id: 6,
    menuItem: 'Home Three Single Page',
    menuLink: '/single-page-home-three',
  },
]
...
export const servicesList: MenuItem[] = [
  ...
  {
    id: 2,
    menuItem: 'maintenance-service',
    menuLink: '/services/maintenance-service',
  },
  {
    id: 3,
    menuItem: 'Lighting & Fixtures',
    menuLink: '/services/lighting-fixtures',
  },
  {
    id: 4,
    menuItem: 'Installing a ceiling fan',
    menuLink: '/services/installing-ceiling-fan',
  },
  {
    id: 5,
    menuItem: 'Commercial services',
    menuLink: '/services/commercial-services',
  },
  {
    id: 6,
    menuItem: 'Short circuit repair',
    menuLink: '/services/short-circuit-repair',
  },
  {
    id: 7,
    menuItem: 'Electric Panel Repair',
    menuLink: '/services/electric-panel-repair',
  },
]
...
export const blogList: MenuItem[] = [
  { id: 1, menuItem: 'Blog', menuLink: '/blogs' },
  { id: 2, menuItem: 'Blog Standard', menuLink: '/blogs/blog-standard' },
  {
    id: 3,
    menuItem: 'Blog Left Sidebar',
    menuLink: '/blogs/blog-left-sidebar',
  },
  {
    id: 4,
    menuItem: 'Blog Right Sidebar',
    menuLink: '/blogs/blog-right-sidebar',
  },
  { id: 5, menuItem: 'Blog Details', menuLink: '/blogs/blog-details' },
]
