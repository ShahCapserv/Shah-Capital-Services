import type { ImgBoxItem } from '../installing-ceiling-fan/InstallingCilingFanMain'
...
import serviceDetailsImg1 from '/assets/images/services/service-details-img-2.jpg'
...
const LightingFixturesMain: React.FC = () => {
  return (
          ...
          <div className="col-xl-8 col-lg-7">
            <div className="service-details__left">
              ...
              <p className="service-details__text-2">
                ...
                laborer et dolore magna aliqua. Out enigma ad minim veniam, quis
                nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                commodo consequat. Duis aute inure dolor in the reprehenderit in
                voluptate velit esse cillum dolore eu fugiat null pariatur.
                Excepteur snit occaecat cupidatat non proident, sunt in culpa
...
export default LightingFixturesMain
