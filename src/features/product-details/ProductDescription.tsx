...
const ProductDescription: React.FC = () => {
  ...
  const handleSubmitReview = (e: SubmitEvent<HTMLFormElement>): void => {
    e.preventDefault()
    const form = e.target
                  ...
                  <div className="product-details__description-content">
                    ...
                    <div className="product-description__list">
                      <ul className="list-unstyled">
                        <li>
                          <p>
                            <span className="icon-right-arrow"></span> Nam at
                            elit nec neque suscipit gravida.
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="icon-right-arrow"></span> Aenean
                            egestas orci eu maximus tincidunt.
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="icon-right-arrow"></span> Curabitur
                            vel turpis id tellus cursus laoreet.
                          </p>
                        </li>
                      </ul>
                    </div>
