            ...
            <div className="product-details__right">
              ...
              <div className="product-details__content">
                <p className="product-details__content-text1">
                  ...
                  formidable, indeed. And these 80 inspiring quotes about books
                  and importance of reading are here to remind you of that. From
                  beloved bestsellers to iconic celebrities, these quotes
                  exemplify the benefits of reading and of a good books to
                  comfort, challenge, and inspire you.
                </p>
