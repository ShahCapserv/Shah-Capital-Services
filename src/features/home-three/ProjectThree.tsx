...
const ProjectThree: React.FC = () => {
  ...
  const handleFilter = (catagiryName: FilterCategory): void => {
    ...
    if (catagiryName !== 'all') {
      const filterProject = projectItems.filter((item: ProjectItem) =>
        item.categories.includes(catagiryName),
      )
              ...
              <div className="project-three__single">
                <div className="project-three__img-box">
                  <div className="project-three__img">
                    ...
                    />
                    <div
                      className="project-three__arrow"
                      onClick={() => {
                        setIndex(i)
                        setOpenLightBox((pre: boolean) => !pre)
                      }}
                    >
                      <a className="img-popup" href={'#'} title="Project Image">
