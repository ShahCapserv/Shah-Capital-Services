        ...
        >
          <SwiperSlide>
            <div className={`item ${activeIndex === 0 ? 'active' : ''}`}>
              <div className="main-slider-three__bg one"></div>
              ...
              <div className="container">
                <div className="main-slider-three__content">
                  <p className="main-slider-three__sub-title">
                    Welcome to Fixpro Quality Repairs Services
                  </p>
                  ...
                  <p className="main-slider-three__text">
                    We honestly want our clients to succeed online in their
                    fields. We create them high-end websites <br /> that stand
                    out on their market, be seen and memorized as a benchmark in
                    what they do.
                  </p>
          ...
          <SwiperSlide>
            <div className={`item ${activeIndex === 1 ? 'active' : ''}`}>
              <div className="main-slider-three__bg two"></div>
              <div className="main-slider-three__overly"></div>
              <div className="main-slider-three__shape-1">
                <img
                  src={shape1}
          ...
          <SwiperSlide>
            <div className={`item ${activeIndex === 2 ? 'active' : ''}`}>
              <div className="main-slider-three__bg three"></div>
              <div className="main-slider-three__overly"></div>
              <div className="main-slider-three__shape-1">
                <img
                  src={shape1}
              ...
              <div className="container">
                <div className="main-slider-three__content">
                  ...
                  <h2 className="main-slider-three__title">
                    General Auto <span>Repair Service</span> <br />
                    This Maintenance Place
                  </h2>
                  <p className="main-slider-three__text">
                    We honestly want our clients to succeed online in their
                    fields. We create them high-end websites <br /> that stand
