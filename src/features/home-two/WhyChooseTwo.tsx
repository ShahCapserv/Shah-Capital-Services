    ...
    <section className="why-choose-two">
      ...
      <div className="container">
        <div className="row">
            ...
            >
              <div className="why-choose-two__img-box">
                <div className="why-choose-two__img-1">
                  <img src={whyChooseTwoImg1} width={470} height={483} alt="" />
                ...
                <div className="why-choose-two__improve-box">
                  <p className="why-choose-two__improve-sub-title">
                    (Based On 5K Reviews)
                  </p>
                  ...
                  <p className="why-choose-two__improve-text">
                    Improve gadget a/c smartphone
                    <br /> laptop repair services.
                  </p>
                </div>
          ...
          <div className="col-xl-6">
            <div
              className="why-choose-two__right wow fadeInRight"
              data-wow-delay="300ms"
            >
              <div className="section-title text-left sec-title-animation animation-style2">
                <h6 className="section-title__tagline">
                  <span className="section-title__tagline-border"></span>Why
                  Choose Us
                </h6>
                <h3 className="section-title__title title-animation">
                  <TextAnimation>
                    Trust An Electrician When You
              ...
              <div className="why-choose-two__points-box">
                {[pointsListOne, pointsListTwo].map((list, listIndex) => (
                  <ul
                    key={listIndex}
                    className="why-choose-two__points-list list-unstyled"
                  >
                    {list.map((point) => (
                      <li key={point.id}>
                        <div className="icon">
