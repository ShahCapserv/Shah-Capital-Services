    ...
    <section className="faq-one">
      <div className="container">
                ...
                <div className="faq-one__ratting-box">
                  ...
                  <p className="faq-one__ratting-text">
                    ...
                    <span className="odometer">
                      <CounterUp ending={5748} />
                    </span>
                    <span>+</span> reviews, Trust
                    <br /> Pilot and ambitionbox.
                  </p>
                </div>
            ...
            <div className="faq-one__right">
              <div className="section-title text-left sec-title-animation animation-style2">
                <h6 className="section-title__tagline">
                  <span className="section-title__tagline-border"></span>Trusted
                  Professionals
                </h6>
        ...
        <div className="faq-one__bottom">
          <p className="faq-one__bottom-text">
            Have Any Questions? Quick Answers to Common Questions.
          </p>
