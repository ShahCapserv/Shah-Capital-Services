            ...
            <div className="about-two__left">
              <div className="section-title text-left sec-title-animation animation-style2">
                <h6 className="section-title__tagline">
                  <span className="section-title__tagline-border"></span>About
                  Our Company
                </h6>
                <h3 className="section-title__title title-animation">
                  <TextAnimation>
                    {' '}
                    Heating & AC Installation <br /> Repair Company
                  </TextAnimation>
                </h3>
              </div>
              ...
              <p className="about-two__text-2">
                At <span>Fixpro</span>, we are a team of highly skilled
                technicians with years of experience in the tech repair
                industry. Our expertise covers a broad spectrum of devices,
                including Ac, laptops, desktops, smartphones, tablets, and
                more..
              </p>
            ...
            >
              <div className="about-two__img-box">
                <div className="about-two__img">
                  <img src={aboutTwoImg1} width={330} height={465} alt="" />
                </div>
                <div className="about-two__img-2">
                  <img src={aboutTwoImg2} width={270} alt="" />
                </div>
                <div className="about-two__experience-box">
                  <div className="about-two__count-box">
                    <h3 className="odometer">
                      <CounterUp ending={25}></CounterUp>
                    </h3>
                    <span>+</span>
                  </div>
