          ...
          <div className="col-xl-6">
            <div className="why-choose-one__left">
              ...
              <p className="why-choose-one__text">
                At our company, we are committed to providing excellent customer
                service, transparent pricing, and fast, reliable service. We
                understand the importance of keeping your home or business cool
                and comfortable.
              </p>
            ...
            >
              <div className="why-choose-one__img-box">
                <div className="why-choose-one__img">
                  <img src={whyChooseOneImg1} width={250} height={450} alt="" />
                </div>
                <div className="why-choose-one__img-2">
                  <img src={whyChooseOneImg2} width={330} height={450} alt="" />
                </div>
